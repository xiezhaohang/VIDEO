...
| `20260820-jieya-wanju-auto-edit-v1` | `解压玩具 Auto Edit v1` | `running` | `handoff` | `timeline 3de8c61832f08c7fa4ca54981ca9e4cf82b49975; render pending checkpoint` | `handoff/runs/20260820-jieya-wanju-auto-edit-v1/` | `source MP4, silent master, extracted frames/screenshots` | `2026-08-20T17:10:00+08:00` | `Machine QA preflight and Human Sanity handoff` |
