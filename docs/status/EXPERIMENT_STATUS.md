...
|---|---|---|---|---|---|---|---|---|
| `20260821-home-commerce-director-experimental-validation-v2-school-memory-book` | `Home Commerce Director Experimental Validation v2 — School Memory Book` | `passed_pending_handoff` | `home-commerce-director-validation-v2` → `handoff` | `pending` | `handoff/runs/20260821-home-commerce-director-experimental-validation-v2-school-memory-book/` | `11 source MP4s and rebuildable diagnostic contact sheets` | `2026-08-21T00:00:00+08:00` | `Publish checkpoint; then user decides whether to begin a separate Cutter validation` |
