...
|---|---|---|---|---|---|---|---|---|
| `20260821-home-commerce-director-experimental-validation-v2-school-memory-book` | `Home Commerce Director Experimental Validation v2 — School Memory Book` | `handed_off` | `handoff` | `payload c0875b5c02177c44a1bf9966345255cd9fbd8304; checkpoint 93304a92cc0222a9de878797c82a4edfdd3d7f75` | `handoff/runs/20260821-home-commerce-director-experimental-validation-v2-school-memory-book/` | `11 source MP4s and rebuildable diagnostic contact sheets` | `2026-08-21T00:00:00+08:00` | `User decides whether to begin a separate controlled Cutter validation; no production promotion` |
| `20260821-home-commerce-director-experimental-validation-v2` | `Home Commerce Director Experimental Validation v2` | `framework_ready_waiting_for_sample` | `home-commerce-director-validation-v2` | `framework 5abd1e99963b070f9245c6e280f8adcbb6020189` | `handoff/runs/20260821-home-commerce-director-experimental-validation-v2/` | `future raw material and any media remain local` | `2026-08-21T00:00:00+08:00` | `Wait for one eligible unseen product, product brief and original source material` |
| `20260821-home-commerce-director-experimental-rule-layer-v1` | `Home Commerce Director Experimental Rule Layer v1` | `handed_off` | `handoff` | `payload ab64d794552330ea77c8b41cfb4c3fa5ea75fa05; source 985941af242e15f4cb5fe7bd3b848ac853dbc1f4` | `handoff/experimental/rules/home_commerce_director_v1_experimental/` | `none` | `2026-08-21T00:00:00+08:00` | `Validate prospectively on one eligible unseen product; no production promotion` |
| `20260821-home-commerce-knowledge-mining-v1` | `Home Commerce Knowledge Mining v1` | `handed_off` | `handoff` | `payload ab64d794552330ea77c8b41cfb4c3fa5ea75fa05; source a88b533c579fad4fa10a01d97bb16d6d8e0d63e0` | `handoff/runs/20260821-home-commerce-knowledge-mining-v1/` | `none` | `2026-08-21T00:00:00+08:00` | `Use as evidence layer for Director Experimental Validation v2; no production promotion` |
| `20260820-8-20-full-inventory-v1` | `D:\8.20剪辑 Full Inventory and Software Readiness Split` | `needs_review` | `handoff` | `pending inventory checkpoint` | `handoff/runs/20260820-8-20-full-inventory-v1/` | `42 source MP4s and extracted review frames` | `2026-08-20T16:46:00+08:00` | `Begin priority-1 Narrative Strategy and Director pass` |
| `20260820-jieya-wanju-auto-edit-v1` | `解压玩具 Auto Edit v1` | `needs_review` | `handoff` | `render 3007fd78165a207dffea81607ffefdfe255b18a4; QA pending checkpoint` | `handoff/runs/20260820-jieya-wanju-auto-edit-v1/` | `source MP4, silent master, extracted QA frames/screenshots` | `2026-08-20T17:13:00+08:00` | `Human full-watch review; no pass claim before review` |
| `20260820-baihuo-usbh09-auto-edit-v1` | `百货USBH09 Auto Edit v1` | `running` | `handoff` | `pending inventory checkpoint` | `handoff/runs/20260820-baihuo-usbh09-auto-edit-v1/` | `source MP4, extracted frames, future renders/audio/screenshots` | `2026-08-20T16:46:00+08:00` | `Narrative Strategy v1 and timeline` |
| `20260820-baihuo-usbh08-auto-edit-v1` | `百货USBH08 Auto Edit v1` | `running` | `handoff` | `pending inventory checkpoint` | `handoff/runs/20260820-baihuo-usbh08-auto-edit-v1/` | `source MP4, extracted frames, future renders/audio/screenshots` | `2026-08-20T16:46:00+08:00` | `Narrative Strategy v1 and timeline` |
| `20260820-nienie-auto-edit-v1` | `捏捏 Auto Edit v1` | `running` | `handoff` | `pending inventory checkpoint` | `handoff/runs/20260820-nienie-auto-edit-v1/` | `source MP4, extracted frames, future renders/audio/screenshots` | `2026-08-20T16:46:00+08:00` | `Narrative Strategy v1 and timeline` |
| `20260820-shudeng-auto-edit-v1` | `书灯 Auto Edit v1` | `running` | `handoff` | `pending inventory checkpoint` | `handoff/runs/20260820-shudeng-auto-edit-v1/` | `source MP4, extracted frames, future renders/audio/screenshots` | `2026-08-20T16:46:00+08:00` | `Narrative Strategy v1 and timeline` |
| `20260820-xuexiao-jiyishu-auto-edit-v1` | `学校记忆书 Auto Edit v1` | `running` | `handoff` | `pending inventory checkpoint` | `handoff/runs/20260820-xuexiao-jiyishu-auto-edit-v1/` | `source MP4, extracted frames, future renders/audio/screenshots` | `2026-08-20T16:46:00+08:00` | `Narrative Strategy v1 and timeline` |
