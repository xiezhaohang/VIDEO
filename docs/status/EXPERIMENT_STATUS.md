...
| `20260820-jieya-wanju-auto-edit-v1` | `解压玩具 Auto Edit v1` | `running` | `handoff` | `pending inventory checkpoint` | `handoff/runs/20260820-jieya-wanju-auto-edit-v1/` | `source MP4, extracted frames, future renders/audio/screenshots` | `2026-08-20T16:46:00+08:00` | `Narrative Strategy v1 and timeline` |
