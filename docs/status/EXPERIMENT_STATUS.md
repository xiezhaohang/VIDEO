...
| `20260820-jieya-wanju-auto-edit-v1` | `解压玩具 Auto Edit v1` | `running` | `handoff` | `inventory c75ebf608ad312095557b4f3c01950aaca366039; strategy pending checkpoint` | `handoff/runs/20260820-jieya-wanju-auto-edit-v1/` | `source MP4, extracted frames, future renders/audio/screenshots` | `2026-08-20T17:01:00+08:00` | `Cutter boundary refinement and timeline` |
