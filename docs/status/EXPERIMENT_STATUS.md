...
|---|---|---|---|---|---|---|---|---|
| `20260821-home-commerce-director-experimental-validation-v2` | `Home Commerce Director Experimental Validation v2` | `framework_ready_waiting_for_sample` | `home-commerce-director-validation-v2` | `pending local checkpoint` | `handoff/runs/20260821-home-commerce-director-experimental-validation-v2/` | `future raw material and any media remain local` | `2026-08-21T00:00:00+08:00` | `Wait for one eligible unseen product, product brief and original source material` |
